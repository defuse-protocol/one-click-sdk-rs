...
pub async fn get_execution_status(
    ...
    deposit_address: &str,
) -> Result<models::GetExecutionStatusResponse, Error<GetExecutionStatusError>> {
...
pub async fn get_tokens(
    configuration: &configuration::Configuration,
) -> Result<Vec<models::TokenResponse>, Error<GetTokensError>> {
...
pub async fn submit_deposit_tx(
    configuration: &configuration::Configuration,
    submit_deposit_tx_request: models::SubmitDepositTxRequest,
) -> Result<models::SubmitDepositTxResponse, Error<SubmitDepositTxError>> {
    // add a prefix to parameters to efficiently prevent name collisions
